        ...
        <div className="relative flex flex-col md:flex-row justify-between items-start md:items-stretch gap-8 md:gap-12">
          ...
          >
            ...
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              At Fin-Forte, our mission is to redefine investment by tokenizing real-world assets, making them easily
          ...
          >
            ...
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              ...
              empowering. Fin-Forte aims to be a global pioneer in bridging traditional finance with blockchain
