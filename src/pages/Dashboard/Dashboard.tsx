...
const Dashboard = () => {
	...
	const handleShareEmail = () => {
		const subject = encodeURIComponent("Join Fin-Forte - Investment Platform");
		const body = encodeURIComponent(
			`Hi! I've been using Fin-Forte for my investments and thought you might be interested. Use my referral link to get started: ${window.location.origin}/?ref=${user.username}`,
		);
	...
	const handleShareSocial = (platform: "facebook" | "twitter") => {
		const referralLink = `${window.location.origin}/?ref=${user.username}`;
		const message = encodeURIComponent("Join me on Fin-Forte - Smart Investment Platform");
							...
							<div className="space-y-8">
								<div>
									...
									<p className="text-gray-600 dark:text-gray-400 leading-relaxed font-normal tracking-wide">
										Invite your friends to Fin-Forte. When they sign up and invest, you'll earn commission
									...
									<div className="flex items-start gap-5">
										...
										<div>
											...
											<p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed font-normal">
												Send your referral link to friends and tell them about Fin-Forte's investment
												opportunities.
											</p>
										</div>
									</div>
							...
							<div className="space-y-8">
								...
								<div>
									...
									<p className="text-sm text-gray-600 dark:text-gray-400 mb-5 leading-relaxed font-normal">
										Send them an email invitation to join Fin-Forte investment platform.
									</p>
