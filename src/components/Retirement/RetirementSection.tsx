...
const RetirementPlanning = () => {
	...
	return (
		<div className="min-h-screen bg-white">
					...
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						<div>
							<h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-8 tracking-tight leading-tight">
								Retirement Planning with <span className="text-blue-500">Fin-Forte</span>
							</h2>
							<p className="text-xl text-gray-600 mb-8 leading-relaxed">
								Planning for retirement is one of the most important financial decisions you will make in your
								lifetime. At Fin-Forte, we understand that building a secure future requires careful
			...
			{/* Why Choose Fin-Forte */}
			<section className="py-20 px-4 sm:px-6 lg:px-8">
				<div className="max-w-6xl mx-auto">
					<div className="mb-16">
						<h2 className="text-4xl font-bold text-gray-900 mb-6">
							Why Choose <span className="text-blue-500">Fin-Forte</span> for Your Retirement Planning?
						</h2>
				...
				<div className="max-w-6xl mx-auto">
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						<div>
							...
							<p className="text-lg text-gray-600 mb-8 leading-relaxed">
								With increasing life expectancies, Fin-Forte helps you plan for a longer retirement. We
