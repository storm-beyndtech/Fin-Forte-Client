			...
			<div className="container mx-auto px-4">
				<div className="flex flex-col md:flex-row">
					...
					<div className="w-full md:w-2/3 bg-blue-500 text-white p-6 sm:p-8 md:p-10 lg:p-12">
						<h3 className="text-base sm:text-lg font-medium mb-3 sm:mb-4">About Fin-Forte LTD</h3>
						...
						>
							Fin-Forte is a proud Australian company with a rich history of pioneering mineral
