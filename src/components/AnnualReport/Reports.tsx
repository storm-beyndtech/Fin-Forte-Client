			...
			<section className="container mx-auto px-4 py-16 md:py-24">
				...
				>
					<h1 className="text-5xl md:text-6xl font-bold leading-tight">
						Fin-Forte's <span className="text-[#1e56ff]">Q3 2024</span> Performance{" "}
						<span className="text-[#1e56ff]">Overview</span>
					</h1>
					<p className="mt-6 text-gray-600 text-lg max-w-2xl">
						In the third quarter of 2024, Fin-Forte achieved a solid growth trajectory, with total sales
