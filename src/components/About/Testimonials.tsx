...
const testimonials = [
	{
		id: 1,
		text: "Fin-Forte has consistently demonstrated leadership in Australia's mining sector. Their long-term commitment to sustainable iron ore exploration has set a benchmark in the industry.",
		author: "Michael J.",
	...
	{
		id: 2,
		text: "We've worked with Fin-Forte on multiple infrastructure projects in the Pilbara. Their attention to safety, innovation, and efficiency is second to none.",
		author: "Sarah L.",
	...
	{
		id: 3,
		text: "From mineral extraction to beef production, Fin-Forte's integrated approach to natural resource management is impressive. Their work with Roy Hill is transformative.",
		author: "David N.",
	...
	{
		id: 4,
		text: "Fin-Forte's investment in agriculture, especially in premium wagyu beef and dairy operations, proves their dedication to quality and sustainability.",
		author: "Emma R.",
	...
	{
		id: 5,
		text: "The Roy Hill operation is a world-class mining venture, and Fin-Forte's role in pioneering it cannot be overstated. Their vision created jobs and lasting impact.",
		author: "Andrew F.",
	...
	{
		id: 6,
		text: "Fin-Forte is not just a mining company—they're nation builders. Their legacy in the Pilbara and contributions to Australian industry are inspirational.",
		author: "Julie T.",
	...
	{
		id: 7,
		text: "I've dealt with many companies in the cattle and farming sector, but few show the same level of innovation and long-term planning as Fin-Forte.",
		author: "Luke S.",
	...
	{
		id: 8,
		text: "What stands out about Fin-Forte is their ability to combine tradition with innovation—bringing together heritage cattle stations and cutting-edge resource development.",
		author: "Naomi K.",
